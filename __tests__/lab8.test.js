describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    let prodItem, shadowRt, button, innerText;
    prodItem = await page.$('product-item')
    shadowRt = await prodItem.getProperty('shadowRoot');
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    cartCont = await page.$('#cart-count');
    innerText = await cartCont.getProperty('innerText');
  ...
  it('Checking the localStorage to make sure cart is correct', async () => {
    ...
    let cart = await page.evaluate(() => Object.assign({}, window.localStorage));;
